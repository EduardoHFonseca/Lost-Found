...
- **URLs Ativas:**
  - Versão Multi-Base com Dicionário de Variáveis: [https://plush-bloom-5dp2.here.now/](https://plush-bloom-5dp2.here.now/)
  - Versão Legada (Base 1): [https://ancient-lagoon-j6mn.here.now/](https://ancient-lagoon-j6mn.here.now/)
